...
export default function Children() {
  ...
  useEffect(() => {
    ...
    async function loadChildren() {
      // กรองเฉพาะลูกของบัญชีตัวเองเสมอ แม้จะเป็น Admin ก็ตาม
      // (Admin มีสิทธิ์เห็นข้อมูลทุกคนได้ผ่าน RLS แต่หน้านี้ตั้งใจให้เป็น "ลูกของฉัน" ของ parent แต่ละคนเท่านั้น)
